...
class ActionFuseDataset(Dataset):
	def __init__(self,
		...
		"""
		if is_val:
			verb_json_path = getattr(args, 'verb_json_path_val', '') or '../LaViLa/output/mvit_verb/egtea_test_feat.pt' #currently using mvit_verb --> rgb
			noun_json_path = getattr(args, 'noun_json_path_val', '') or '../LaViLa/output/mvit_noun/egtea_test_feat.pt'
			act_json_path = getattr(args, 'act_json_path_val', '') or '../LaViLa/output/lavila/egtea_test_feat.pt'
		else:
			verb_json_path = getattr(args, 'verb_json_path_train', '') or '../LaViLa/output/mvit_verb/egtea_train_feat.pt'  #currently using mvit_verb --> rgb
			noun_json_path = getattr(args, 'noun_json_path_train', '') or '../LaViLa/output/mvit_noun/egtea_train_feat.pt'
			act_json_path = getattr(args, 'act_json_path_train', '') or '../LaViLa/output/lavila/egtea_train_feat.pt'
