...
def get_args(description='whl'):
    ...
    parser.add_argument('--seq_len',
                        type=int,
                        default=16,
                        help='temporal length of verb/noun features')
    ...
    parser.add_argument('--noun_dim',
                        ...
                        default=180,
                        help='')
    parser.add_argument('--verb_json_path_train',
                        type=str,
                        default='',
                        help='override path to verb train features')
    parser.add_argument('--verb_json_path_val',
                        type=str,
                        default='',
                        help='override path to verb val/test features')
    parser.add_argument('--noun_json_path_train',
                        type=str,
                        default='',
                        help='override path to noun train features')
    parser.add_argument('--noun_json_path_val',
                        type=str,
                        default='',
                        help='override path to noun val/test features')
    parser.add_argument('--act_json_path_train',
                        type=str,
                        default='',
                        help='override path to action train features')
    parser.add_argument('--act_json_path_val',
                        type=str,
                        default='',
                        help='override path to action val/test features')
